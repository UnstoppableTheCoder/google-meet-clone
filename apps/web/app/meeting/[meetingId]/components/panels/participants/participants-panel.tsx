    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/5">
        <div className="min-w-0">
          <h2 className="font-semibold text-base leading-tight text-white flex items-center gap-2">
            People
            <span
      ...
      <div className="p-3 border-b border-white/5">
        <div className="relative">
          ...
          <Input
            ...
            className={[
              "h-10 rounded-full pl-9 pr-4",
              "bg-white/5 border border-white/10",
              "text-sm text-white placeholder:text-white/40",
              "focus-visible:ring-2 focus-visible:ring-blue-500/40 focus-visible:border-white/10",
              "transition-colors",
            ].join(" ")}
          />
        </div>
      ...
      {/* Permission modal — kept outside ScrollArea, anchored to panel */}
      <PermissionModal />
    </motion.aside>
  );
}
